...
namespace TurisClick.Api.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260917011152_0009_Oleada9_DestinationImagesAndTouristPreferences")]
    partial class _0009_Oleada9_DestinationImagesAndTouristPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("PreferredDestinationId")
                        .HasColumnType("uuid")
                        .HasColumnName("preferred_destination_id");

                    b.Property<string>("RestrictionsNotes")
                        .HasColumnType("text")
                        .HasColumnName("restrictions_notes");
                    ...
                    b.HasIndex("TouristId")
                        .HasDatabaseName("ix_ai_conversations_tourist_id");
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiItinerary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AiConversationId")
                        .HasDatabaseName("ix_ai_itineraries_conversation_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_ai_itineraries_status");

                    b.HasIndex("TouristId")
                        .HasDatabaseName("ix_ai_itineraries_tourist_id");

                    b.ToTable("ai_itineraries", (string)null);
                });

            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiItineraryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AiItineraryId")
                        .HasDatabaseName("ix_ai_itinerary_items_itinerary_id");
                    ...
                    b.ToTable("ai_itinerary_items", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ai_itinerary_items_product_shape", "(product_type = 'EXPERIENCE' AND experience_id IS NOT NULL AND package_id IS NULL AND package_availability_id IS NULL) OR (product_type = 'PACKAGE' AND package_id IS NOT NULL AND experience_id IS NULL AND experience_availability_id IS NULL)");
                        });
                });

            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Preferences.Entities.TouristPreference", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.Property<string>("TravelParty")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("travel_party");
                    ...
                    b.ToTable("tourist_preferences", (string)null);
                });
            ...
            modelBuilder.Entity("ai_conversation_categories", b =>
                {
                    ...
                    b.HasKey("ai_conversation_id", "category_id");

                    b.HasIndex("category_id");

                    b.ToTable("ai_conversation_categories", (string)null);
                });
            ...
            modelBuilder.Entity("tourist_preference_categories", b =>
                {
                    ...
                    b.HasIndex("category_id")
                        .HasDatabaseName("ix_tourist_preference_categories_category_id");

                    b.ToTable("tourist_preference_categories", (string)null);
                });

            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiConversation", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Destinations.Entities.Destination", "PreferredDestination")
                        .WithMany()
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiItinerary", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Ai.Entities.AiConversation", "AiConversation")
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Ai.Entities.AiItineraryItem", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Ai.Entities.AiItinerary", "AiItinerary")
                        .WithMany("Items")
                        .HasForeignKey("AiItineraryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Preferences.Entities.TouristPreference", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Auth.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("TurisClick.Api.Modules.Preferences.Entities.TouristPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TurisClick.Api.Modules.Reservations.Entities.Reservation", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Ai.Entities.AiItinerary", null)
                        .WithMany()
                        .HasForeignKey("AiItineraryId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ai_conversation_categories", b =>
                {
                    b.HasOne("TurisClick.Api.Modules.Ai.Entities.AiConversation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("tourist_preference_categories", b =>
                {
                    ...
                    b.HasOne("TurisClick.Api.Modules.Preferences.Entities.TouristPreference", null)
                        .WithMany()
