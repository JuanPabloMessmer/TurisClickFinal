...
| `set-keyvault-secrets.ps1` | Genera y carga `jwt-key` y `seed-admin-password` | ⏸ no ejecutado |
| `create-db-role.ps1` | Crea el rol `turisclick_v2_app`, lo hace dueño de `turisclick_db_v2` y carga `db-connection-string` | ⏸ no ejecutado |
