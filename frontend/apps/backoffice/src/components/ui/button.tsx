...
/**
 * "accent" (naranja) es la marca de énfasis puntual (UC pedido: "utilizarlo con moderación") — nunca es
 * el hover neutro de un botón secundario. Los hovers neutros (outline/ghost) usan `muted`, no `accent`.
 */
